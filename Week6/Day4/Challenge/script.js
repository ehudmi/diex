...
const displayGroceries = () => {
  groceries.fruits.forEach(function (value) {
    console.log(value);
  });
...
const cloneGroceries = () => {
  let user = client;
  client = "Betty";
  //The user will not change - client is defined as "Betty" after the variable user is defined as "John"
  let shopping = groceries;
  groceries.totalPrice = "35$";
  //The shopping object will also be modified because they both refer to the same object
